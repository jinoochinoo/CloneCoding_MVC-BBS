	...
	<div class="row">
		...
		<div class="col-md-auto">
			...
			<form action="boardWriter" method="post">
				...
				<button type="submit" class="btn btn-primary" style="text-align: center;">답글</button>
				<a onclick="return confirm('정말로 삭제하시겠습니까?')" 
					href="/board/boardDelete?bdNum=<%=dto.getBdNum()%>" class="btn btn-secondary" style="text-align: center;">삭제</a>
			</form>
		...
		<table class="table">
			<thead>
				<tr class="table-active">
					<th scope="col" style="width: 60%">제목 : <%=dto.getBdTitle()%><br>
					조회 : <%=dto.getBdViewCount()%>	</th>
					<th scope="col" style="width: 40%" class="text-right">작성자 : <%=dto.getBdUserID()%>
						<br> <%=dto.getBdDate()%></th>
				</tr>
			</thead>
			<tbody>
